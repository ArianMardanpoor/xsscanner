...
func main() {
	...
	flag.StringVar(&cfg.OutDir, "d", "nice_params_output", "Output directory to save <HOST>-param.txt files")
	flag.StringVar(&cfg.OutDir, "dir", "nice_params_output", "Output directory (alias)")
